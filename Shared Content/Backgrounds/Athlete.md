...
### **Table- Suggested Athlete Characteristics**

`dice: [[2. Mechanics Reference Almanac/Backgrounds/Athlete]]^PersonTrait]]`
...
`dice: [[2. Mechanics Reference Almanac/Backgrounds/Athlete]]^Ideal]]`
...
`dice: [[2. Mechanics Reference Almanac/Backgrounds/Athlete]]^Bond]]`
...
`dice: [[2. Mechanics Reference Almanac/Backgrounds/Athlete]]^Flaw]]`
