...
## House Tool Proficiencies Table

`dice: [[House Agent]]^Houses]]`
...
### **Table- Suggested House Agent Characteristics**

`dice: [[House Agent]]^PersonTrait]]`
