...
### **Table- Suggested Celebrity Adventurer's Scion Characteristics**

`dice: [[Celebrity Adventurer's Scion]]^PersonTrait]]`
...
`dice: [[Celebrity Adventurer's Scion]]^Ideal]]`
...
`dice: [[Celebrity Adventurer's Scion]]^Bond]]`
...
`dice: [[Celebrity Adventurer's Scion]]^Flaw]]`
