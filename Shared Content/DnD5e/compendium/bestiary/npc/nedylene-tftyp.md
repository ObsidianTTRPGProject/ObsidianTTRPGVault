...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "spells"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Nedylene carries a [staff of swarming insects](/compendium/items/staff-of-swarming-insects.md)."
  "name": "Special Equipment"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Nedylene has advantage on saving throws against being [charmed](/rules/conditions.md#charmed),\
...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Scourge +2"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Nedylene attempts to magically summon a [yochlol](/compendium/bestiary/fiend/yochlol.md)\
    \ with a 30|30 percent|30% summoning chance% chance chance of success. If the\
    \ attempt fails, Nedylene takes 5 (1d10) psychic damage. Otherwise, the summoned\
