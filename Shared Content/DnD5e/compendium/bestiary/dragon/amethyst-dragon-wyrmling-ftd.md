...
- !!int "13"
- !!int "17"
"speed": "walk 30 ft., fly 60 ft. (hover), swim 30 ft."
"saves":
  "Charisma": !!int "5"
  "Dexterity": !!int "2"
  "Wisdom": !!int "3"
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ each: [protection from evil and good](/compendium/spells/protection-from-evil-and-good.md),\
...
**Amethyst Dragon Wyrmling Connections.** | dice: d6 | Connected Creatures |
|----------|---------------------|
