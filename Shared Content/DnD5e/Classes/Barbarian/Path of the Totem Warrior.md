...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [[Beast Sense|Beast Sense]] and [[Speak with Animals|Speak with Animals]] spells, but only as rituals, as described in the Spellcasting section.
