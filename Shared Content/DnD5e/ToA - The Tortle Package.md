...
## The Snout of Omgar
![[Snout of Omgar DM.webp|right|300]]

![[Snout of Omgar Player.jpg|right|300]]
...
#### Eeyal
*Prerequisite: tortle guide (Fort Beluarian)*
...
### Ahoyhoy
![[Ahoyhoy DM.webp|right|300]]

![[Ahoyhoy Player.jpg|right|300]]
...
There's a 20 percent chance that a hatchery contains 1d12 tortle eggs. If eggs are present, 1d2 elderly **tortles** (see "Tortles,") watch over them. Each tortle egg weighs 5 pounds. A newborn tortle is usually confined to its hatchery for a few months, until it learns to walk on two legs.
...
Tortles gather here to trade with friendly visitors. Two **tortles** (see "Tortles,") stand guard on the ramparts, keeping an eye out for visitors or trouble approaching from the south.
...
![[Dangwaru DM.webp|right|300]]

![[Dangwaru Player.jpg|right|300]]
...
It's a 20-foot drop from the garden to the sea. During the day, the garden is home to harmless **lizards**, snakes, and **spiders**, but nothing dangerous. At night, seven **Topis** lurk amid the plants and other wildlife. They try to surprise any character who wanders into the garden. No treasure is hidden here.
...
***Treasure.*** A character who searches the 3-foot-deep sunken bath and succeeds on a DC 13 Wisdom (Perception) check finds a holy symbol of **Umberlee** (25 gp) in the undergrowth.
...
A *detect magic* spell reveals an aura of transmutation magic emanating from the pool. The pool has the following powers, which an *identify* spell can ascertain:
...
***Treasure.*** When the ghost is laid to rest, it leaves behind a *pearlescent conch shell* that weighs 2 pounds. The conch radiates an aura of evocation magic under the scrutiny of a *detect magic* spell or similar effect. An *identify* spell reveals that the conch is a single-use magic item with the following property: a creature can use an action to blow the conch like a horn, creating an effect identical with that of a *Leomund's tiny hut* spell. The conch disappears once the spell takes effect. The effect ends if the creature that blew the horn leaves the spell's area.
...
Six **Topis** hide in the clay urns, two per urn. All six emerge and attack if any urn is disturbed or if the double door to the west is opened.
...
### Mud Pits of Florrb
In the heart of the island's jungle are three pools of mud heated by geothermal vents. Each pool is within sight of the other two and is 5 feet deep, 50 feet wide, and roughly circular. (The pools shown on map 1 are not to scale.) A *detect magic* spell reveals a faint aura of abjuration magic around each pool. The tortles of the island like to bathe and relax in the mud pools for hours at a time, singing and bellowing to pass the time. A winding foot trail connects the mud pits to the tortle fort of *Ahoyhoy*.
...
- One of **Ras Nsi's** greatest enemies is a **Guardian Naga** named Saja N'baza. The naga dwells in a fallen kingdom called *Orolunga*. Neither Ssura nor Y'zleth knows how to get there.
...
![[Mudgraw.jpg|right|300]]

### Handout D: Holy Symbol of Umberlee
![[HolySymbolOfUmberlee.webp|right|300]]