...
## Overview
### Xvart Speaker
![[Xvart Speaker.jpg|Xvart Speaker|300]]
[[Xvart Speaker.jpg|open outside]]

**Alignment**: Chaotic Evil

**Armor Class**: 13 (leather armor)

**Hit Points**: 7 (`dice: 2d6`)
...
## Actions
***Shortsword.** Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. Hit: 5 (`dice: 1d6+2`) piercing damage.

***Sling.** Ranged Weapon Attack:* +4 to hit, range 30/120 ft., one target. Hit: 4 (`dice: 1d4+2`) bludgeoning damage.
...
```ad-tip
title: Flavor
If you say the name Raxivort three times while gazing at your reflection in a mirror, rvarts will visit you in th dead of night and steal a cherished trinket. -Volo

```
```ad-tip
title: Flavor
If Ye believe what Volo tells ye, ye deserve no less. -Elminsster
