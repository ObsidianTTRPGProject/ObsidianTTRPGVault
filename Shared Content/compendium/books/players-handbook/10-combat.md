...
> [!quote] Variant: Playing on a Grid
> 
...
Using the Attack action, you can make a special melee attack to shove a creature, either to knock it [prone](/rules/conditions.md#prone) or push it away from you. If you're able to make multiple attacks with the Attack action, this attack replaces one of them.
...
> [!quote] Describing the Effects of Damage
> 
