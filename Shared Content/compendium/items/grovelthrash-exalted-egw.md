...
- **Damage**:
  - One-handed: 1d8 B
  - Two-handed: 1d10 B
- **Properties**: [Versatile](/rules/item-properties.md#Versatile), [Martial](/rules/item-properties.md#Martial), [Requires Attunement](/rules/item-properties.md#Requires%20Attunement)
- **Cost**: ⏤
- **Weight**: 2.0 lbs.
...
- As an action, you can use the warhammer to cast one of the following spells from it (save DC 17): [earthquake](/compendium/spells/earthquake.md), [meld into stone](/compendium/spells/meld-into-stone.md), or [stone shape](/compendium/spells/stone-shape.md). Once a spell has been cast using the warhammer, that spell can't be cast from the warhammer again until the next dawn.
...
Grovelthrash is a sentient neutral evil weapon with an Intelligence of 18, a Wisdom of 15, and a Charisma of 19. It has hearing and [darkvision](/rules/senses.md#darkvision) out to a range of 120 feet.
...
- While holding this weapon, you have advantage on Wisdom ([Insight](/rules/skills.md#Insight)) checks made to discern a lie spoken in a language you understand.
