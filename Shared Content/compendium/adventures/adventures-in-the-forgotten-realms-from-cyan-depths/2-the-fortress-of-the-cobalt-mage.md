...
Tyreus has used up a number of magical resources he once possessed to form tenuous bonds with a few elementals in the region. He tasked them with scouring the lakeshore for the Stone of Creation. When it was found, just offshore amid heaps of loose stones, Tyreus used a [telekinesis](/compendium/spells/telekinesis.md) spell and the elementals' help to bring the Stone into his keep's cellar vault (area 8).
...
Two [air elementals](/compendium/bestiary/elemental/air-elemental.md), two [water elementals](/compendium/bestiary/elemental/water-elemental.md), and one [earth elemental](/compendium/bestiary/elemental/earth-elemental.md) roam the lakeshore's waters, stony edges, and skies near the fortress.
...
The third floor's eastern doorway is trapped with a glyph of warding's explosive runes and a linked glyph connected to an alarm glyph (DC 18 to detect both); the effect glyph for the alarm is in Tyreus's sanctum (area 10). The glyphs respond to any creature that does not say the password "visionary" before passing through the doorway. If [Tyreus](/compendium/bestiary/npc/tyreus-illusionist-aitfr-fcd.md) is alerted to an intruder, he prepares for combat as described in his entry in appendix A. For more about [linked glyphs](/compendium/spells/linked-glyphs-aitfr-avt.md), see appendix B.
...
The [Stone of Creation](/compendium/items/stone-of-creation-aitfr-avt.md) has been recovered by Tyreus and is here, set upon a clean bronze brazier at one end of the room, near the doors.
...
A [chip of creation](/compendium/items/chip-of-creation-aitfr-avt.md) sits on a wooden plate under a glass lid here.
...
The books stacked on the floor and scattered on the table were all looted from other wizards' collections. They include speculations on the origins and location of the [Stone of Creation](/compendium/items/stone-of-creation-aitfr-avt.md) as well as the sigil combinations for various teleportation circles (in locations of the DM's choosing). One of them is a [spellbook](/compendium/items/spellbook.md) containing the spells [teleport](/compendium/spells/teleport.md), [teleportation circle](/compendium/spells/teleportation-circle.md), [stone shape](/compendium/spells/stone-shape.md), [stoneskin](/compendium/spells/stoneskin.md), and [wall of stone](/compendium/spells/wall-of-stone.md). The historical and arcane texts are worth a total of 2,250 gp to the right collectors.
...
Even Tyreus isn't sure what this room is for other than adding height to the keep and looking out at the stars of Faerûn. The circle of sigils is a place for Tyreus to cast [teleport](/compendium/spells/teleport.md)ation circle and other spells but is not an active or permanent magical feature.
