...
Begin play in the sparring room of the Critical Strike Combat School where Orange is exercising and practicing various skills with the sword. In the training room, Orange has access to one energy drink which acts as a [potion of healing](/compendium/items/potion-of-healing.md).
...
If Orange defeats the goons, [Mr. Honeycutt](/compendium/bestiary/npc/mr-honeycutt-nrh-tcmc.md) arrives just after, hoping to warn Orange of the impending fight.
...
If Orange agrees to help, Mr. Honeycutt offers a reward of 20 gp for the return of the gem. He also gives Orange a [necklace of fireballs](/compendium/items/necklace-of-fireballs.md) with one bead remaining. As he gives the item to Orange, Mr. Honeycutt says, "I hope you never have to use this."
...
The staircase leads down to a corridor that ends in a rotting wood door which can be easily opened or broken down. However, lurking on the ceiling of this corridor is a [gray ooze](/compendium/bestiary/ooze/gray-ooze.md).
...
If Orange listens at the door to this tomb before opening it, they hear tapping or clacking sounds. Opening the door reveals two [skeletons](/compendium/bestiary/undead/skeleton.md) repeatedly bumping into each other. When the door opens, they attack.
...
Orange has discovered a [gelatinous cube](/compendium/bestiary/ooze/gelatinous-cube.md) that's behaving oddly!

##### Encounter Adjustments

The gelatinous cube is weakened from its attempts to digest the Peach Gem and a magic sword, both of which it has engulfed. When Orange discovers the [gelatinous cube](/compendium/bestiary/ooze/gelatinous-cube.md), it only has 40 hit points remaining and it doesn't have its Transparent trait.

##### Defeating the Cube

Even in its weakened stat, a gelatinous cube is no easy task. Hopefully, Orange uses the last bead of the necklace of fireballs to finish off the cube. If that doesn't work, have [Mr. Honeycutt](/compendium/bestiary/npc/mr-honeycutt-nrh-tcmc.md) arrive with four [guards](/compendium/bestiary/humanoid/guard.md) to help Orange defeat the cube. Have the cube attack the guards first before attacking Mr. Honeycutt or Orange.
...
|----------|----------|
| 1 | +1 greatsword |
| 2 | [Potion of healing](/compendium/items/potion-of-healing.md) |
| 3 | [Ring of protection](/compendium/items/ring-of-protection.md) |
| 4 | Two metal gambling dice |
| 5 | The Peach Gem |
| 6 | Brass bell |
^gelatinous-cube-treasures

When the gelatinous cube is reduced to 24 hit points or fewer, it spits out the +1 greatsword, the [potion of healing](/compendium/items/potion-of-healing.md), and the glowing orange gem (the Peach Gem), and makes its retreat by dashing away.
...
- [Necklace of Fireballs](/compendium/items/necklace-of-fireballs.md)
- [Ring of Protection](/compendium/items/ring-of-protection.md)
- [Scroll of Protection (Aberrations)](/compendium/items/scroll-of-protection-from-aberrations.md)
- Weapon, +1