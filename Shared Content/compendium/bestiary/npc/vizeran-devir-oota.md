...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "spells"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The vizeran devir's innate spellcasting ability is Charisma (spell save\
    \ DC 15). The vizeran devir can innately cast the following spells, requiring\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The vizeran devir has advantage on saving throws against being charmed,\
    \ and magic can't put the vizeran devir to sleep."
  "name": "Fey Ancestry"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "While in sunlight, the vizeran devir has disadvantage on attack rolls,\
