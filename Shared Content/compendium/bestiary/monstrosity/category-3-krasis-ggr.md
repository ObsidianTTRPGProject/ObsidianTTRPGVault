...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Claws"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +11 to hit, reach 15 ft., one target. Hit: 33 (6d8\
    \ + 6) bludgeoning damage. If the target is a creature, it must succeed on a DC\
    \ 19 Strength saving throw or be knocked [prone](/rules/conditions.md#prone)."
  "name": "Tail"
"source":
- "GGR"
name: Category 3 Krasis
image: "[[Category 3 Krasis.png]]"
---
