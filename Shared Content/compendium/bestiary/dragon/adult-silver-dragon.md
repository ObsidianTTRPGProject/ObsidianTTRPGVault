...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The dragon uses one of the following breath weapons.\n\n- Cold Breath.\
    ...
    \ The dragon exhales paralyzing gas in a 60-foot cone. Each creature in that area\
    \ must succeed on a DC 20 Constitution saving throw or be [paralyzed](/rules/conditions.md#paralyzed)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
