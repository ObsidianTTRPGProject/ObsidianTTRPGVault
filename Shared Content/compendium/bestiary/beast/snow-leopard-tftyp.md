...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The leopard has advantage on Wisdom ([Perception](/rules/skills.md#Perception))\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "If the leopard moves at least 20 feet straight toward a creature and then\
    ...
    \ If the target is [prone](/rules/conditions.md#prone), the leopard can make one\
