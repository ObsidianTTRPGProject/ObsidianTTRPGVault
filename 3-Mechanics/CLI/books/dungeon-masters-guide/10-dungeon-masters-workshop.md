...
- [Climb onto a Bigger Creature](/3-Mechanics/CLI/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](/3-Mechanics/CLI/rules/actions.md#Disarm)  
- [Mark](/3-Mechanics/CLI/rules/actions.md#Mark)  
- [Overrun](/3-Mechanics/CLI/rules/actions.md#Overrun)  
- [Shove Aside](/3-Mechanics/CLI/rules/actions.md#Shove%20Aside)  
- [Tumble](/3-Mechanics/CLI/rules/actions.md#Tumble)  
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](/3-Mechanics/CLI/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](/3-Mechanics/CLI/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) bonus.
