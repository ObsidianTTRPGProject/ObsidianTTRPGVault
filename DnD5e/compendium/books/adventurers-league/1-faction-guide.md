...
|---------|--------------------|
| Harpers | Musical Instrument, [Calligrapher's supplies](/compendium/items/calligraphers-supplies.md), or [Disguise Kit](/compendium/items/disguise-kit.md) |
| Order of the Gauntlet | [Smith's tools](/compendium/items/smiths-tools.md), [Leatherworker's tools](/compendium/items/leatherworkers-tools.md), [Carpenter's tools](/compendium/items/carpenters-tools.md), [Mason's tools](/compendium/items/masons-tools.md), Vehicles |
| Emerald Enclave | [Herbalism kit](/compendium/items/herbalism-kit.md), [Woodcarver's tools](/compendium/items/woodcarvers-tools.md), [Cartographer's tools](/compendium/items/cartographers-tools.md) |
| Lords' Alliance | [Jeweler's tools](/compendium/items/jewelers-tools.md), [Mason's tools](/compendium/items/masons-tools.md), [Navigator's tools](/compendium/items/navigators-tools.md), [Painter's supplies](/compendium/items/painters-supplies.md), Gaming Set, Any Standard Language |
| Zhentarim | [Disguise Kit](/compendium/items/disguise-kit.md), [Forgery kit](/compendium/items/forgery-kit.md), [Poisoner's kit](/compendium/items/poisoners-kit.md) [Thieves' tools](/compendium/items/thieves-tools.md), |
^faction-training
