...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Lancing Bolt"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Ranged Weapon Attack: +7 to hit, range 50/200 ft., one target. Hit: 9\
    \ (1d10 + 4) piercing damage, and the target is [grappled](/rules/conditions.md#grappled)\
    ...
    \ it closer to the clockwork. A creature takes 5 (1d10) slashing damage if it\
    \ escapes from the grapple or if it tries and fails. The clockwork can grapple\
...
- "MTF"
name: Clockwork Oaken Bolter
image: "[[Clockwork Oaken Bolter.png]]"
---
