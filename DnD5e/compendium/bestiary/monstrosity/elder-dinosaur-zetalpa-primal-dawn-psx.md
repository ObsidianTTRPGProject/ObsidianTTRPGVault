...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The elder dinosaur can use its Frightful Presence. It then makes five attacks:\
    \ one with its bite, two with its claws, and two with its wings. It can use its\
...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Claw"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +19 to hit, reach 20 ft., one target. Hit: 28 (4d8\
...
- "PSX"
name: Elder Dinosaur (Zetalpa, Primal Dawn)
image: "[[Elder Dinosaur (Zetalpa, Primal Dawn).png]]"
---
