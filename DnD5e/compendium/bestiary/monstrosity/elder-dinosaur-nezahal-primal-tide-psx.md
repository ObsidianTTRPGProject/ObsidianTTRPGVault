...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Siege Monster"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The elder dinosaur can hold its breath for 4 hours."
  "name": "Hold Breath"
"actions":
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The elder dinosaur can use its Frightful Presence. It then makes five attacks:\
    \ one with its bite and four with its flippers. No two flipper attacks can target\
    \ the same creature. It can use its Swallow instead of its bite."
  "name": "Multiattack"
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Bite"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +19 to hit, reach 5 ft., one target. Hit: 28 (4d8\
...
- "PSX"
name: Elder Dinosaur (Nezahal, Primal Tide)
image: "[[Elder Dinosaur (Nezahal, Primal Tide).png]]"
---
