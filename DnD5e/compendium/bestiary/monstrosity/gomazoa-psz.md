...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +7 to hit, reach 50 ft., one creature. Hit: The\
    ...
    \ has disadvantage on Strength checks and Strength saving throws, and the gomazoa\
    \ can't use the same tendril on another target."
  "name": "Tendril"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The gomazoa pulls each creature [grappled](/rules/conditions.md#grappled)\
