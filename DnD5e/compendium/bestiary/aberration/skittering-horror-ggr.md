...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Multiattack"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 28 (4d10\
    \ + 6) piercing damage."
  "name": "Bite"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 24 (4d8\
    \ + 6) slashing damage."
  "name": "Claws"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The horror targets one creature it can see within 30 feet of it. If the\
    ...
    \ throw. On a failed saving throw, the target becomes [paralyzed](/rules/conditions.md#paralyzed)\
