...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The ultroloth's eyes sparkle with opalescent light as it targets one creature\
    ...
    \ must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](/rules/conditions.md#charmed)\
    \ until the end of the ultroloth's next turn. The [charmed](/rules/conditions.md#charmed)\
    \ target is [stunned](/rules/conditions.md#stunned). If the target's saving throw\
    \ is successful, the target is immune to the ultroloth's gaze for the next 24\
    \ hours."
  "name": "Hypnotic Gaze"
- !!dev.ebullient.json5e.qute.Trait
