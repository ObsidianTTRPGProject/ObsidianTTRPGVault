...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Any creature hostile to the pit fiend that starts its turn within 20 feet\
    ...
    \ is [incapacitated](/rules/conditions.md#incapacitated). On a failed save, the\
    \ creature is [frightened](/rules/conditions.md#frightened) until the start of\
    \ its next turn. If a creature's saving throw is successful, the creature is immune\
