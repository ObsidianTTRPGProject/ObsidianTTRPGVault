...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Zilchyn is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "spells"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The zilchyn q'leptin's innate spellcasting ability is Charisma (spell save\
    \ DC 11). The zilchyn q'leptin can innately cast the following spells, requiring\
    \ no material components:\n\nAt will: [dancing lights](/compendium/spells/dancing-lights.md)\n\
    \n1/day each: [darkness](/compendium/spells/darkness.md), [faerie fire](/compendium/spells/faerie-fire.md)"
  "name": "innate"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The zilchyn q'leptin has advantage on saving throws against being charmed,\
    \ and magic can't put the zilchyn q'leptin to sleep."
  "name": "Fey Ancestry"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "While in sunlight, the zilchyn q'leptin has disadvantage on attack rolls,\
