...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a DC\
    ...
    \ control of its body. Agony now controls the body but doesn't deprive the target\
    \ of awareness. Agony can't be targeted by any attack, spell, or other effect,\
    ...
    \ 0 hit points, Agony ends it as a bonus action, or Agony is turned or forced\
