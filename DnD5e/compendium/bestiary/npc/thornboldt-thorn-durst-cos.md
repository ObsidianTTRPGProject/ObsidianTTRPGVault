...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "One humanoid that Thorn can see within 5 feet of it must succeed on a DC\
    ...
    \ control of its body. Thorn now controls the body but doesn't deprive the target\
    \ of awareness. Thorn can't be targeted by any attack, spell, or other effect,\
    ...
    \ 0 hit points, Thorn ends it as a bonus action, or Thorn is turned or forced\
...
- "CoS"
name: Thornboldt Thorn Durst
image: "[[Thornboldt Thorn Durst.png]]"
---
