...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Afsoun has advantage on saving throws against being charmed, and magic\
    \ can't put Afsoun to sleep."
  "name": "Fey Ancestry"
"actions":
- !!dev.ebullient.json5e.qute.Trait
...
*Source: Journeys through the Radiant Citadel p. 342*
