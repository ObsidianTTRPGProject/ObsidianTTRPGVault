...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "Siege Monster"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Zalto wears a [ring of lightning resistance](/compendium/items/ring-of-lightning-resistance.md)."
  "name": "Special Equipment"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "When Zalto enters any enemy's space for the first time on a turn, the enemy\
    \ must succeed on a DC 19 Strength saving throw or be knocked [prone](/rules/conditions.md#prone)."
  "name": "Tackle"
"actions":
- !!dev.ebullient.json5e.qute.Trait
