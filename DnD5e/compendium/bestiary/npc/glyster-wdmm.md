...
"legendary_actions":
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Glyster makes a Wisdom ([Perception](/rules/skills.md#Perception)) check."
  "name": "Detect"
- !!dev.ebullient.json5e.qute.Trait
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Glyster beats its wings. Each creature within 10 feet of Glyster must succeed\
    \ on a DC 20 Dexterity saving throw or take 14 (2d6 + 7) bludgeoning damage and\
    \ be knocked [prone](/rules/conditions.md#prone). Glyster can then fly up to half\
    \ its flying speed."
