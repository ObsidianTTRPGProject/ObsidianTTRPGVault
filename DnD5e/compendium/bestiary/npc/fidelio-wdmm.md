...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "One humanoid that Fidelio can see within 5 feet of it must succeed on a\
    ...
    \ control of its body. Fidelio now controls the body but doesn't deprive the target\
    \ of awareness. Fidelio can't be targeted by any attack, spell, or other effect,\
    ...
    \ 0 hit points, Fidelio ends it as a bonus action, or Fidelio is turned or forced\
