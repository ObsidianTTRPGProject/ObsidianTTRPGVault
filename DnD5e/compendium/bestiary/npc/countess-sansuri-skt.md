...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Sansuri casts one of the following spells, requiring no material components\
    ...
    \ of invulnerability](/compendium/spells/globe-of-invulnerability.md), [haste](/compendium/spells/haste.md),\
    \ [hypnotic pattern](/compendium/spells/hypnotic-pattern.md), [ice storm](/compendium/spells/ice-storm.md),\
    \ [lightning bolt](/compendium/spells/lightning-bolt.md), [Mordenkainen's sword](/compendium/spells/mordenkainens-sword.md),\
    \ [wall of force](/compendium/spells/wall-of-force.md)\n\n2/day each: [arcane\
    \ lock](/compendium/spells/arcane-lock.md), [gust of wind](/compendium/spells/gust-of-wind.md),\
    \ [invisibility](/compendium/spells/invisibility.md), [magic missile](/compendium/spells/magic-missile.md),\
    \ [unseen servant](/compendium/spells/unseen-servant.md)"
  "name": "spells"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Sansuri has advantage on Wisdom ([Perception](/rules/skills.md#Perception))\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Sansuri tries to throw a Small or Medium creature within 10 feet of her.\
    ...
    \ 60 feet horizontally in a direction of Sansuri's choice and land [prone](/rules/conditions.md#prone),\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "A magical aura of wind surrounds Sansuri. The aura is a 10-foot-radius\
    \ sphere that lasts as long as Sansuri maintains concentration on it (as if concentrating\
    \ on a spell). While the aura is in effect, Sansuri gains a +2 bonus to its AC\
