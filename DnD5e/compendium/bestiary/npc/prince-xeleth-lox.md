...
- !!dev.ebullient.json5e.qute.Trait
  ...
  "name": "spells"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](/rules/conditions.md#charmed)\
    \ condition on itself, and magic can't put it to sleep."
  "name": "Fey Ancestry"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Xeleth wears a suit of elven chain."
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Xeleth has a 50 percent chance of magically summoning a [young solar dragon](/compendium/bestiary/dragon/young-solar-dragon-bam.md).\
