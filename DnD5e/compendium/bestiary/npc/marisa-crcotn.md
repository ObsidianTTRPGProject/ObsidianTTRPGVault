...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Marisa can see 60 feet into the Ethereal Plane when it is on the Material\
    \ Plane, and vice versa."
  "name": "Ethereal Sight"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Marisa can move through other creatures and objects as if they were difficult\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Marisa enters the Ethereal Plane from the Material Plane, or vice versa.\
  ...
  "name": "Etherealness"
- !!dev.ebullient.json5e.qute.Trait
  "desc": "Each non-undead creature within 60 feet of Marisa that can see it must\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "One humanoid that Marisa can see within 5 feet of it must succeed on a\
    \ DC 13 Charisma saving throw or be possessed by Marisa; Marisa then disappears,\
    \ and the target is [incapacitated](/rules/conditions.md#incapacitated) and loses\
    \ control of its body. Marisa now controls the body but doesn't deprive the target\
    \ of awareness. Marisa can't be targeted by any attack, spell, or other effect,\
    ...
    \ 0 hit points, Marisa ends it as a bonus action, or Marisa is turned or forced\
    \ out by an effect like the [dispel evil and good](/compendium/spells/dispel-evil-and-good.md)\
    \ spell. When the possession ends, Marisa reappears in an unoccupied space within\
