...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The fungal servant targets one creature it can see within 60 feet of it.\
    ...
    \ throw by 5 or more, it is also [paralyzed](/rules/conditions.md#paralyzed) for\
    \ the same duration. A target that succeeds on the saving throw is immune to the\
    \ Dreadful Glare of all fungal servants for the next 24 hours."
  "name": "Dreadful Glare"
"legendary_actions":
- !!dev.ebullient.json5e.qute.Trait
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The fungal servant utters a blasphemous word. Each non-undead creature\
    ...
    \ succeed on a DC 16 Constitution saving throw or be [stunned](/rules/conditions.md#stunned)\
...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "The fungal servant magically transforms into a whirlwind of spores, moves\
    ...
    \ fungal servant is immune to all damage, and it can't be [grappled](/rules/conditions.md#grappled),\
