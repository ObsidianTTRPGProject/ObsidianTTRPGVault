...
- !!dev.ebullient.json5e.qute.Trait
  "desc": "One humanoid that the spirit can see within 5 feet of it must succeed on\
    ...
    \ Intelligence, Wisdom, Charisma, and immunity to being [charmed](/rules/conditions.md#charmed)\
    ...
    \ 0 hit points, the spirit ends it as a bonus action, or the spirit is turned\
