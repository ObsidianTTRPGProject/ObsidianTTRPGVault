...
- spell/class/bard
- spell/class/cleric/ambition/psa
- spell/class/cleric/trickery
- spell/class/ranger/gloom-stalker
- spell/class/ranger/revised/gloom-stalker
...
**Classes**: Artificer, Artificer (Revisited), Bard, Cleric (Ambition (PSA)), Cleric (Trickery), Ranger (Gloom Stalker), Ranger (Revised) (Gloom Stalker), Rogue (Arcane Trickster), Sorcerer, Wizard
