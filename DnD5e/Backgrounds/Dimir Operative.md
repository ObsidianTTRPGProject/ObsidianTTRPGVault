...
`dice: [[Dimir Operative]]^ReasonForInfiltration]]`
...
### **Table- Suggested Dimir Operative Characteristics**

`dice: [[Dimir Operative]]^PersonTrait]]`
...
`dice: [[Dimir Operative]]^ContactAlly]]`
