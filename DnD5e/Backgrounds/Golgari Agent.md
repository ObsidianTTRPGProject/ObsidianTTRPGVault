...
### **Table- Suggested Golgari Agent Characteristics**

`dice: [[Golgari Agent]]^PersonTrait]]`
...
`dice: [[Golgari Agent]]^ContactAlly]]`
...
`dice: [[Golgari Agent]]^NoncontactRival]]`
