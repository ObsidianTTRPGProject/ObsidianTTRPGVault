...
## Overview
### Bone Devil Polearm
![[Bone Devil Polearm.png|Bone Devil Polearm|300]]
[[Bone Devil Polearm.png|open outside]]

```encounter
name: Encounter
creatures:
 - 1: Bone Devil Polearm
```
...
***Hooked Polearm.*** *Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. Hit: 17 (`dice: 2d12+4`) piercing damage. If the target is a huge or smaller creature, it is grappled (escape DC 14). Until the grapple ends, the devil can't use its polearm on another target.

***Claw.*** *Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. Hit: 8 (`dice: 1d8+4`) slashing damage.

***Sting.*** *Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. Hit: 13 (`dice: 2d8+4`) piercing damage plus 17 (`dice: 5d6`) poison damage, and the target must succeed on a DC 14 Constitution saving throw or become poisoned for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
